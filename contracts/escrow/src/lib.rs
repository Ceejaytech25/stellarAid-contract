...
#[contractimpl]
impl EscrowContract {
    pub fn create_escrow(_env: Env, _commission_id: Bytes, _client: Address, _artist: Address, _amount: i128, _config_contract: Address) { todo!() }
    ...
    pub fn get_escrow(_env: Env, _commission_id: Bytes) -> EscrowRecord { todo!() }
